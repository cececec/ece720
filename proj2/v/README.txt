...
*  An AHB-Lite Stub is provided capable of generating burst transactions.
   The Cortex-M0 processor can be replaced with the stub by uncommenting
   the line at the head of src/rtl/cortex_soc.v that defines the macro
   USE_STUB.  Modify the "Stub Behavior" section of src/rtl/AHBlite_stub.sv
   to create your own transactions. 
