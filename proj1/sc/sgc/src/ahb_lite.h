...
public:
  ...
  typedef tlm_utils::simple_target_socket_tagged<AHBlite> target_socket_type;
  typedef tlm_utils::simple_initiator_socket_tagged<AHBlite> initiator_socket_type;
