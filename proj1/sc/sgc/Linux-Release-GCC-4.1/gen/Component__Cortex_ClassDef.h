...
public:
	...
	{
		ovrd_params["mul"] = eslapi::CADIParameterInfo_t(0x10000000 | PARAMETERFILTER_FIXED, "mul",eslapi::CADI_PARAM_INT, "Clock Rate Multiplier",0,MxS64CONST(0x8000000000000000),MxS64CONST(0x7fffffffffffffff),MxS64CONST(0x1), "1" );
	}
};
...
public:
	...
	{
		ovrd_params["size"] = eslapi::CADIParameterInfo_t(0x10000001 | PARAMETERFILTER_FIXED, "size",eslapi::CADI_PARAM_INT, "Maximum size of memory region",0,MxS64CONST(0x8000000000000000),MxS64CONST(0x7fffffffffffffff),MxS64CONST(0x1000000000000), "0x1000000000000" );
	}
};
