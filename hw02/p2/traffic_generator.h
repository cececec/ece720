...
//=============================================================================
  ...
  , unsigned int        num_reads             ///< number of reads in read lo
  );
...
// Member Variables 
  ...
  const unsigned int  m_read_write_loops;           // number iterations through read & write loops
  const unsigned int  m_num_writes;                 // number of writes in write loop
  const unsigned int  m_num_reads;                  // number of reads in read lo
  bool                m_check_all;
